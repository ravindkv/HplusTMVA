...
TCanvas * compareMjjOneSys(TH1F* hBase, TH1F* hUp, TH1F* hDown, TString process, TString sys, TString cat){
  ...
  hRatio_Up->SetMarkerColor(kGreen); hRatio_Up->SetLineColor(kGreen); hRatio_Up->GetYaxis()->SetRangeUser(0.8, 1.3);
...
TCanvas * compareRatioGraph(TH1F* hBase, TH1F* hUp, TH1F* hDown, TString process, TString sys, TString cat){
  ...
  hRatio_Up->GetYaxis()->SetRangeUser(0.8, 1.3);
...
void npShapeVslnN_13TeV(){
  ...
  mjjFiles.push_back(filePath+"/Cat3_cTagEx/Mass120/Shapes_hcs_13TeV_ele_KinFit_mjj_kfit_CTagExL_WH120.root"); 
  mjjFiles.push_back(filePath+"/Cat3_cTagEx/Mass120/Shapes_hcs_13TeV_ele_KinFit_mjj_kfit_CTagExM_WH120.root"); 
  mjjFiles.push_back(filePath+"/Cat3_cTagEx/Mass120/Shapes_hcs_13TeV_ele_KinFit_mjj_kfit_CTagExT_WH120.root"); 
  ...
  for(itr = mjjFiles.begin(); itr!= mjjFiles.end(); itr++){
    ...
    TH1F* hTTbarscaleDown = getHisto(f, "ttbar_scaleRF_ttDown");
    TH1F* hTTbarmatchingUp = getHisto(f, "ttbar_hDamp_ttUp");
    TH1F* hTTbarmatchingDown = getHisto(f, "ttbar_hDamp_ttDown");
    ...
    if(isBkg && isGraph){//Graph
      ...
      TCanvas * c_GraphTTbarscale = compareRatioGraph(hTTbar, hTTbarscaleUp, hTTbarscaleDown, "ttbar", "scaleRF", cat_);
      canBkgGraph->cd(7);
      c_GraphTTbarscale->DrawClonePad();
      TCanvas * c_GraphTTbarmatching = compareRatioGraph(hTTbar, hTTbarmatchingUp, hTTbarmatchingDown, "ttbar", "hDamp", cat_);
      canBkgGraph->cd(8);
